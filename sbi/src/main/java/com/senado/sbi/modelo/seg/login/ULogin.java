...
public class ULogin {
	...
	public String toString() {
		return "ULogin [cUsuario=" + cUsuario + ", cContrasena=" + cContrasena + ", cToken=" + cToken + ", cNombre="
				+ cNombre + ", cPaterno=" + cPaterno + ", cMaterno=" + cMaterno + ", cPuesto=" + cPuesto
				+ ", cExtension=" + cExtension + ", cCorreo=" + cCorreo + ", lHonorarios=" + lHonorarios + ", iPerfil="
				+ iPerfil + ", lActivo=" + lActivo + ", dtCreado=" + dtCreado + ", dtModificado=" + dtModificado
				+ ", cUsuarioR=" + cUsuarioR + "]";
	}
